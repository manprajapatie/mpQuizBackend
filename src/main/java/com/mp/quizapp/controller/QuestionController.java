...
public class QuestionController {
    ...
    //With this we will get all quation with route of /question/allQuestions >> question is our main route and allQuestions we are defining below and getting it from service
    ...
    //We want result based on catagory that's why we are giving it another route with dynamic route {category}
